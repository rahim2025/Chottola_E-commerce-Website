...
/**
 * Phone Signup Page
 * Allows users to register with phone number and OTP
 */
const PhoneSignup = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await authService.registerWithPhone(phone, otp, name);
      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-8">
        ...
        {step === 'name' && (
          <form onSubmit={handleRegister}>
            ...
            <button
              ...
              className="w-full mt-3 bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-3 rounded-lg transition duration-200"
            >
              ← Back
            </button>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="flex justify-center gap-2">
            ...
            <div
              className={`w-3 h-3 rounded-full transition-all ${
                step === 'name' ? 'bg-blue-600' : 'bg-gray-300'
              }`}
            ></div>
          </div>
        </div>
